...
public class UserGetRequestWithPathMethod {
    ...
    public void Task41() {
        ...
        System.out.println("first book isbn should be = " + response.path("books.isbn[0]"));
        System.out.println("first book publisher should be = " + response.path("books.publisher[0]"));

        int isbn=response.path("books.isbn[0]");

        String lastName=response.path("books.publisher[0]");
